...
class AppTextStyles {
  ...
  static final TextStyle titleFoodItemBold = GoogleFonts.notoSans(
    color: AppColors.black,
    fontSize: 13,
    fontWeight: FontWeight.w600,
  );

  static final TextStyle priceFoodItemBold = GoogleFonts.notoSans(
    color: AppColors.primaryColor,
    fontSize: 16,
    fontWeight: FontWeight.w600,
  );

  static final TextStyle bodyBoldBlack = GoogleFonts.notoSans(
    color: AppColors.black,
    fontSize: 15,
    fontWeight: FontWeight.bold,
  );

  static final TextStyle bodyBoldWhite = GoogleFonts.notoSans(
  ...
  static final TextStyle buttonTextStyle = GoogleFonts.notoSans(
    color: AppColors.white,
    fontSize: 18,
    fontWeight: FontWeight.bold,
  );

  static final TextStyle buttonSecTextStyle = GoogleFonts.notoSans(
    color: AppColors.black,
    fontSize: 18,
    fontWeight: FontWeight.bold,
  );
  ...
  static final TextStyle homeButton = GoogleFonts.notoSans(
    color: AppColors.primaryColor,
    fontSize: 20,
    fontWeight: FontWeight.bold,
  );
